module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      'dist': {
        ...
        src: [
          'bootstrap-select/js/select2.js',
          'src/js/wrapper.end.js'
        ],
        dest: 'bootstrap-select/js/select2.js'
      },
      'dist.full': {
        options: {
          banner: grunt.file.read('src/js/wrapper.start.js'),
        ...
        src: [
          'bootstrap-select/js/select2.full.js',
          'src/js/wrapper.end.js'
        ],
        dest: 'bootstrap-select/js/select2.full.js'
      }
    },
    ...
    uglify: {
      'dist': {
        src: 'bootstrap-select/js/select2.js',
        dest: 'bootstrap-select/js/select2.min.js',
        options: {
          banner: minifiedBanner
        }
      },
      'dist.full': {
        src: 'bootstrap-select/js/select2.full.js',
        dest: 'bootstrap-select/js/select2.full.min.js',
        options: {
          banner: minifiedBanner
        }
      }
    ...
    requirejs: {
      'dist': {
        options: {
          ...
          optimize: 'none',
          name: 'select2/core',
          out: 'bootstrap-select/js/select2.js',
          include: includes,
          namespace: 'S2',
          paths: {
      ...
      'dist.full': {
        options: {
          ...
          optimize: 'none',
          name: 'select2/core',
          out: 'bootstrap-select/js/select2.full.js',
  ...
  grunt.registerTask('compile', [
    'requirejs:bootstrap-select', 'requirejs:bootstrap-select.full', 'requirejs:i18n',
    'concat:bootstrap-select', 'concat:bootstrap-select.full',
    'sass:dev'
  ]);
  grunt.registerTask('minify', ['uglify', 'sass:bootstrap-select']);

module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    clean: {
      ...
      docs: 'docs/docs/bootstrap-select'
    },
    ...
    concat: {
      ...
      main: {
        src: '<%= jshint.main.src %>',
        dest: 'bootstrap-select/js/<%= pkg.name %>.js'
      },
      i18n: {
        expand: true,
        src: '<%= jshint.i18n.src %>',
        dest: 'bootstrap-select/'
      }
    },
    ...
    umd: {
      ...
      i18n: {
        ...
        src: 'bootstrap-select/<%= jshint.i18n.src %>',
        dest: '.'
      }
    },
    ...
    uglify: {
      ...
      main: {
        src: '<%= concat.main.dest %>',
        dest: 'bootstrap-select/js/<%= pkg.name %>.min.js',
        options: {
          sourceMap: true,
          sourceMapName: 'bootstrap-select/js/<%= pkg.name %>.js.map'
        }
      },
      i18n: {
        expand: true,
    ...
    less: {
      ...
      css: {
        ...
        dest: 'bootstrap-select/css/<%= pkg.name %>.css'
      }
    },
    ...
    usebanner: {
      ...
      js: {
        ...
        src: [
          '<%= concat.main.dest %>',
          '<%= uglify.main.dest %>',
          'bootstrap-select/<%= jshint.i18n.src %>',
        ]
      }
    },
    ...
    copy: {
      docs: {
        expand: true,
        cwd: 'bootstrap-select/',
        src: [
          '**/*'
        ],
        dest: 'docs/docs/bootstrap-select/'
      }
    },
    ...
    cssmin: {
      ...
      css: {
        src: '<%= less.css.dest %>',
        dest: 'bootstrap-select/css/<%= pkg.name %>.min.css'
      }
    },

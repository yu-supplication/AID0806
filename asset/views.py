...
from deploy.models import SaltHost, UpdateHostInfo
...
def SheetWrite(sheet, row, serverasset, style):
    ...
    sheet.write(row,16, serverasset.networkarea, style)
    sheet.write(row,17, serverasset.idc, style)
    ...
    if request.method == 'GET':
        if request.user.has_perm('asset.view_asset'):
            ...
            if request.GET.has_key('export'):
                ...
                #1st line
                row0 = [u'主机名',u'操作系统',u'内核',u'Salt版本',u'ZeroMQ版本','Shell','Locale','SELinux',u'CPU型号',u'CPU线程',u'内存',u'硬盘容量',u'网络地址',u'平台',u'序列号',u'厂商型号',u'网络区域',u'IDC机房']
